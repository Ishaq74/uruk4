...
export const EVENTS: Event[] = [
    { id: 'ev1', slug: 'festival-du-film-danimation', date: '09-15 JUIN', title: 'Festival du Film d\'Animation', location: 'Bonlieu Scène Nationale', imageUrl: 'https://picsum.photos/seed/event1/400/300', category: 'Festival', price: 'À partir de 15€', description: 'L\'événement mondial du cinéma d\'animation.', coordinates: { lat: 45.901, lng: 6.130 }, status: 'published' },
    { id: 'ev2', slug: 'fete-de-la-musique', date: '21 JUIN', title: 'Fête de la Musique', location: 'Toute la ville', imageUrl: 'https://picsum.photos/seed/event2/400/300', category: 'Concert', price: 'Gratuit', description: 'Des concerts gratuits à chaque coin de rue.', coordinates: { lat: 45.899, lng: 6.129 }, status: 'published' },
    { id: 'ev3', slug: 'noctibules-dannecy', date: '1-7 JUILLET', title: 'Noctibules d\'Annecy', location: 'Jardins de l\'Europe', imageUrl: 'https://picsum.photos/seed/event3/400/300', category: 'Festival', price: 'Gratuit', description: 'Festival de rue avec spectacles, concerts et animations pour toute la famille.', coordinates: { lat: 45.901, lng: 6.131 }, status: 'published' },
    { id: 'ev4', slug: 'marche-de-la-vieille-ville', date: 'CHAQUE VENDREDI', title: 'Marché de la Vieille Ville', location: 'Rue Sainte-Claire', imageUrl: 'https://picsum.photos/seed/annecy4/400/300', category: 'Marché', price: 'Gratuit', description: 'Le marché traditionnel au coeur de la vieille ville.', coordinates: { lat: 45.898, lng: 6.125 }, status: 'published' },
    { id: 'ev5', slug: 'feu-dartifice-du-14-juillet', date: '15 JUILLET', title: 'Feu d\'Artifice du 14 Juillet', location: 'Plage d\'Albigny', imageUrl: 'https://picsum.photos/seed/event5/400/300', category: 'Culture', price: 'Gratuit', description: 'Feu d\'artifice spectaculaire au-dessus du lac pour célébrer la fête nationale.', coordinates: { lat: 45.903, lng: 6.137 }, status: 'published' },
    { id: 'ev6', slug: 'fete-du-lac', date: '5 AOÛT', title: 'Fête du Lac', location: 'Lac d\'Annecy', imageUrl: 'https://picsum.photos/seed/event6/400/300', category: 'Festival', price: 'Gratuit', description: 'Le plus grand spectacle pyrotechnique d\'Europe sur le lac.', coordinates: { lat: 45.900, lng: 6.130 }, status: 'published' },
    { id: 'ev7', slug: 'venetian-carnival', date: '12-15 AOÛT', title: 'Venetian Carnival', location: 'Canaux d\'Annecy', imageUrl: 'https://picsum.photos/seed/event7/400/300', category: 'Festival', price: '10€', description: 'Carnaval vénitien sur les canaux avec gondoles et costumes d\'époque.', coordinates: { lat: 45.899, lng: 6.127 }, status: 'published' },
    { id: 'ev8', slug: 'marche-bio-du-paquier', date: 'CHAQUE SAMEDI', title: 'Marché Bio du Paquier', location: 'Paquier', imageUrl: 'https://picsum.photos/seed/event8/400/300', category: 'Marché', price: 'Gratuit', description: 'Marché de producteurs locaux et biologiques.', coordinates: { lat: 45.901, lng: 6.129 }, status: 'published' },
    { id: 'ev9', slug: 'marathon-du-lac', date: '20 SEPTEMBRE', title: 'Marathon du Lac', location: 'Tour du Lac', imageUrl: 'https://picsum.photos/seed/event9/400/300', category: 'Sport', price: '45€', description: 'Course à pied autour du lac d\'Annecy, parcours de 42km.', coordinates: { lat: 45.900, lng: 6.130 }, status: 'published' },
    { id: 'ev10', slug: 'marche-de-noel', date: '1-15 DÉCEMBRE', title: 'Marché de Noël', location: 'Centre-ville', imageUrl: 'https://picsum.photos/seed/event10/400/300', category: 'Marché', price: 'Gratuit', description: 'Marché de Noël traditionnel avec chalets, vin chaud et artisanat local.', coordinates: { lat: 45.899, lng: 6.128 }, status: 'published' },
];

export const TRAILS: Trail[] = [
    { id: 't1', slug: 'mont-veyrier-mont-baron', name: 'Mont Veyrier - Mont Baron', imageUrl: 'https://picsum.photos/seed/trail1/800/600', distanceKm: 7.5, durationMin: 240, ascentM: 850, difficulty: TrailDifficulty.Hard, excerpt: 'Une randonnée exigeante offrant les plus belles vues panoramiques.', description: '<p>Le sentier du Mont Veyrier est un classique pour les Annéciens.</p>', startPoint: { lat: 45.910, lng: 6.165 }, gpxUrl: '/gpx/mont-veyrier.gpx', status: 'published' },
    { id: 't2', slug: 'cascade-dangon', name: 'Cascade d\'Angon', imageUrl: 'https://picsum.photos/seed/trail2/800/600', distanceKm: 3, durationMin: 90, ascentM: 250, difficulty: TrailDifficulty.Medium, excerpt: 'Une balade rafraîchissante vers une cascade impressionnante.', description: '<p>Idéal pour les journées chaudes.</p>', startPoint: { lat: 45.845, lng: 6.183 }, status: 'published' },
    { id: 't3', slug: 'le-semnoz-par-les-puisots', name: 'Le Semnoz par les Puisots', imageUrl: 'https://picsum.photos/seed/trail3/800/600', distanceKm: 12, durationMin: 300, ascentM: 950, difficulty: TrailDifficulty.Hard, excerpt: 'Ascension sportive jusqu\'au sommet du Semnoz.', description: '<p>Vue exceptionnelle sur le lac et les Alpes au sommet.</p>', startPoint: { lat: 45.850, lng: 6.090 }, gpxUrl: '/gpx/semnoz.gpx', status: 'published' },
    { id: 't4', slug: 'tour-du-lac-dannecy', name: 'Tour du Lac d\'Annecy', imageUrl: 'https://picsum.photos/seed/trail4/800/600', distanceKm: 42, durationMin: 180, ascentM: 150, difficulty: TrailDifficulty.Easy, excerpt: 'Circuit vélo familial autour du lac sur piste cyclable.', description: '<p>Parcours plat et sécurisé, parfait pour les familles.</p>', startPoint: { lat: 45.900, lng: 6.130 }, status: 'published' },
    { id: 't5', slug: 'col-de-la-forclaz', name: 'Col de la Forclaz', imageUrl: 'https://picsum.photos/seed/trail5/800/600', distanceKm: 8, durationMin: 210, ascentM: 650, difficulty: TrailDifficulty.Medium, excerpt: 'Belle montée vers un col offrant une vue splendide.', description: '<p>Point de départ des parapentes, ambiance montagnarde.</p>', startPoint: { lat: 45.860, lng: 6.180 }, gpxUrl: '/gpx/forclaz.gpx', status: 'published' },
    { id: 't6', slug: 'roc-de-chere', name: 'Roc de Chère', imageUrl: 'https://picsum.photos/seed/trail6/800/600', distanceKm: 5, durationMin: 120, ascentM: 180, difficulty: TrailDifficulty.Easy, excerpt: 'Promenade dans une réserve naturelle protégée.', description: '<p>Sentier ombragé avec points de vue sur le lac.</p>', startPoint: { lat: 45.838, lng: 6.184 }, status: 'published' },
    { id: 't7', slug: 'la-tournette', name: 'La Tournette', imageUrl: 'https://picsum.photos/seed/trail7/800/600', distanceKm: 11, durationMin: 360, ascentM: 1200, difficulty: TrailDifficulty.Expert, excerpt: 'Ascension du plus haut sommet autour du lac.', description: '<p>Randonnée alpine exigeante, équipement de montagne recommandé.</p>', startPoint: { lat: 45.820, lng: 6.230 }, gpxUrl: '/gpx/tournette.gpx', status: 'published' },
    { id: 't8', slug: 'ermitage-de-saint-germain', name: 'Ermitage de Saint-Germain', imageUrl: 'https://picsum.photos/seed/trail8/800/600', distanceKm: 4, durationMin: 90, ascentM: 220, difficulty: TrailDifficulty.Easy, excerpt: 'Courte randonnée vers un ermitage historique.', description: '<p>Accessible à tous, belle vue sur Annecy et le lac.</p>', startPoint: { lat: 45.908, lng: 6.125 }, status: 'published' },
];

export const ALL_LISTINGS: Listing[] = [
    { id: 'l1', slug: 'developpeur-full-stack-h-f', title: 'Développeur Full-Stack (H/F)', type: ListingType.Emploi, price: '45k€ - 55k€', date: 'Aujourd\'hui', imageUrl: 'https://picsum.photos/seed/job1/200/200', metadata: { company: 'Annecy Tech', contractType: 'CDI' }, userId: 'p2', description: 'Notre startup en pleine croissance recherche un développeur passionné.', status: 'published' },
    { id: 'l2', slug: 'appartement-t2-vue-lac', title: 'Appartement T2 vue lac', type: ListingType.Immobilier, price: '450 000 €', date: 'Hier', imageUrl: 'https://picsum.photos/seed/immo1/200/200', metadata: { surface: '45m²', 'pièces': 2 }, userId: 'p4', description: 'Particulier vend magnifique T2 de 45m² au dernier étage.', status: 'published' },
    { id: 'l3', slug: 'vends-velo-de-course', title: 'Vends vélo de course', type: ListingType.BonnesAffaires, price: '350 €', date: 'Il y a 3 jours', imageUrl: 'https://picsum.photos/seed/velo1/200/200', metadata: { brand: 'Lapierre', state: 'Excellent' }, userId: 'p3', description: 'Vends vélo de course en carbone, taille M.', status: 'published' },
    { id: 'l4', slug: 'chef-de-projet-digital', title: 'Chef de projet digital', type: ListingType.Emploi, price: '40k€ - 50k€', date: 'Il y a 2 jours', imageUrl: 'https://picsum.photos/seed/job2/200/200', metadata: { company: 'Digital Savoie', contractType: 'CDI' }, userId: 'p2', description: 'Agence digitale recherche chef de projet expérimenté.', status: 'published' },
    { id: 'l5', slug: 'studio-meuble-centre-ville', title: 'Studio meublé centre-ville', type: ListingType.Immobilier, price: '750 €/mois', date: 'Aujourd\'hui', imageUrl: 'https://picsum.photos/seed/immo2/200/200', metadata: { surface: '25m²', 'pièces': 1 }, userId: 'p4', description: 'Studio meublé disponible immédiatement, charges comprises.', status: 'published' },
    { id: 'l6', slug: 'kayak-2-places', title: 'Kayak 2 places', type: ListingType.BonnesAffaires, price: '600 €', date: 'Hier', imageUrl: 'https://picsum.photos/seed/kayak1/200/200', metadata: { brand: 'Décathlon', state: 'Très bon' }, userId: 'p1', description: 'Kayak gonflable 2 places, peu utilisé, avec pagaies.', status: 'published' },
    { id: 'l7', slug: 'cours-particuliers-maths-physique', title: 'Cours particuliers maths/physique', type: ListingType.Services, price: '30 €/h', date: 'Il y a 1 semaine', imageUrl: 'https://picsum.photos/seed/service1/200/200', metadata: { level: 'Lycée/Prépa' }, userId: 'p3', description: 'Professeur expérimenté propose cours particuliers tous niveaux.', status: 'published' },
    { id: 'l8', slug: 'maison-t4-avec-jardin', title: 'Maison T4 avec jardin', type: ListingType.Immobilier, price: '680 000 €', date: 'Il y a 4 jours', imageUrl: 'https://picsum.photos/seed/immo3/200/200', metadata: { surface: '110m²', 'pièces': 4 }, userId: 'p4', description: 'Belle maison avec jardin, garage, proche du lac.', status: 'published' },
    { id: 'l9', slug: 'skis-chaussures', title: 'Skis + chaussures', type: ListingType.BonnesAffaires, price: '200 €', date: 'Il y a 2 jours', imageUrl: 'https://picsum.photos/seed/ski1/200/200', metadata: { brand: 'Rossignol', state: 'Bon' }, userId: 'p2', description: 'Skis paraboliques 170cm + chaussures taille 42.', status: 'published' },
    { id: 'l10', slug: 'garde-danimaux', title: 'Garde d\'animaux', type: ListingType.Services, price: '20 €/jour', date: 'Il y a 5 jours', imageUrl: 'https://picsum.photos/seed/service2/200/200', metadata: { animals: 'Chiens, chats' }, userId: 'p1', description: 'Étudiante passionnée propose garde d\'animaux à domicile.', status: 'published' },
    { id: 'l11', slug: 'responsable-boutique', title: 'Responsable boutique', type: ListingType.Emploi, price: '35k€ - 38k€', date: 'Il y a 1 semaine', imageUrl: 'https://picsum.photos/seed/job3/200/200', metadata: { company: 'Boutique Montagne', contractType: 'CDI' }, userId: 'p2', description: 'Boutique de sport recherche responsable pour gestion équipe.', status: 'published' },
    { id: 'l12', slug: 'canape-dangle-cuir', title: 'Canapé d\'angle cuir', type: ListingType.BonnesAffaires, price: '400 €', date: 'Il y a 3 jours', imageUrl: 'https://picsum.photos/seed/canape1/200/200', metadata: { state: 'Très bon' }, userId: 'p3', description: 'Canapé d\'angle en cuir noir, excellent état, cause déménagement.', status: 'published' },
];

export const MAGAZINE_ARTICLES: Article[] = [
  { 
    id: 'mag1', 
    slug: 'les-5-plus-beaux-spots-pour-le-coucher-de-soleil',
  ...
  { 
    id: 'mag2', 
    slug: 'portrait-pierre-gay-maitre-fromager',
  ...
  { 
    id: 'mag3', 
    slug: 'les-meilleures-tables-savoyardes-dannecy',
  ...
  { 
    id: 'mag4', 
    slug: 'le-festival-du-film-danimation-fete-ses-45-ans',
  ...
  { 
    id: 'mag5', 
    slug: 'randonnee-nos-conseils-pour-debuter',
  ...
  { 
    id: 'mag6', 
    slug: 'le-lac-dannecy-pourquoi-est-il-si-pur',
